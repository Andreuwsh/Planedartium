...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    CelestialBody$(x, y, radius, color, mass, $name, inclination, isSun) {
      var t1 = new A.CelestialBody(x, y, radius, color, $name, A._setArrayType([], type$.JSArray_List_double), isSun, inclination),
        t2 = t1.__CelestialBody_orbitalRadius_A = Math.sqrt(x * x + y * y);
      if (!isSun)
        t1.__CelestialBody_angularVelocity_A = Math.sqrt(13274608977599998e4 / (t2 * t2 * t2));
      return t1;
    },
    main() {
      var ctx, planets, pauseButton, speedSlider, speedValue, t3, t4, t1 = {},
        t2 = document,
        canvas = type$.nullable_CanvasElement._as(t2.querySelector("#solarSystem"));
      if (canvas == null) {
        A.printString("Canvas element not found!");
        return;
      }
      ctx = type$.CanvasRenderingContext2D._as(B.CanvasElement_methods.getContext$1(canvas, "2d"));
      planets = A._setArrayType([A.CelestialBody$(0, 0, 20, "#FFE87C", 198892e25, "\u0421\u043e\u043b\u043d\u0446\u0435", 0, true), A.CelestialBody$(578952e5, 0, 6, "#A9A9A9", 33e22, "\u041c\u0435\u0440\u043a\u0443\u0440\u0438\u0439", 0.122173, false), A.CelestialBody$(1081608e5, 0, 10, "#FFC649", 487e22, "\u0412\u0435\u043d\u0435\u0440\u0430", 0.059, false), A.CelestialBody$(1496e8, 0, 10, "#6495ED", 597e22, "\u0417\u0435\u043c\u043b\u044f", 0.041, false), A.CelestialBody$(2279904e5, 0, 8, "#BC2732", 642e21, "\u041c\u0430\u0440\u0441", 0.032, false), A.CelestialBody$(374e9, 0, 15, "#FF7D11", 19e26, "\u042e\u043f\u0438\u0442\u0435\u0440", 0.022, false), A.CelestialBody$(4488e8, 0, 14, "#E8E8CD", 568e24, "\u0421\u0430\u0442\u0443\u0440\u043d", 0.026, false), A.CelestialBody$(5236e8, 0, 12, "#ADD8E6", 868e23, "\u0423\u0440\u0430\u043d", 0, false), A.CelestialBody$(5984e8, 0, 12, "#000080", 102e24, "\u041d\u0435\u043f\u0442\u0443\u043d", 0, false)], type$.JSArray_CelestialBody);
      t1.isPaused = false;
      t1.simulationSpeed = 1;
      pauseButton = type$.ButtonElement._as(t2.querySelector("#pauseButton"));
      speedSlider = type$.InputElement._as(t2.querySelector("#speedSlider"));
      speedValue = type$.SpanElement._as(t2.querySelector("#speedValue"));
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(pauseButton, "click", t3._as(new A.main_closure(t1, pauseButton)), false, t2);
      t4 = type$._ElementEventStreamImpl_Event;
      A._EventStreamSubscription$(speedSlider, "input", t4._eval$1("~(1)?")._as(new A.main_closure0(t1, speedSlider, speedValue)), false, t4._precomputed1);
      A._EventStreamSubscription$(canvas, "mousemove", t3._as(new A.main_closure1(canvas, planets)), false, t2);
      t2 = window;
      t2.toString;
      B.Window_methods.requestAnimationFrame$1(t2, new A.main_update(t1, ctx, planets));
    },
    CelestialBody: function CelestialBody(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _.x = t0;
      _.y = t1;
      _.z = 0;
      ...
      _.color = t3;
      _.name = t4;
      _.__CelestialBody_orbitalRadius_A = $;
      _.trail = t5;
      _.isSun = t6;
      _.__CelestialBody_angularVelocity_A = $;
      _.__CelestialBody_inclination_A = t7;
      _.isHovered = false;
    },
    ...
    main_update: function main_update(t0, t1, t2) {
      this._box_0 = t0;
      this.ctx = t1;
      this.planets = t2;
    },
  ...
  A.CanvasRenderingContext2D.prototype = {
    ...
    ellipse$8(receiver, x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise) {
      return receiver.ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, false);
    },
  ...
  A.CelestialBody.prototype = {
    to2D$3(x, y, z) {
      return A._setArrayType([(x - z) * Math.cos(0.5235987755982988), y + (x + z) * Math.sin(0.5235987755982988)], type$.JSArray_double);
    },
    draw$1(ctx) {
      var t3, angle, t4, t5, t6, t7, t8, t9, isoOrbit, i, isoTrail, r, g, b, highlightGradient, _this = this,
        iso = _this.to2D$3(_this.x * 5681818181818182e-25, _this.y * 5681818181818182e-25, _this.z * 5681818181818182e-25),
        screenX = iso[0] + 400,
        screenY = iso[1] + 300,
        t1 = _this.isSun,
        t2 = !t1;
      if (t2) {
        ctx.beginPath();
        B.CanvasRenderingContext2D_methods.set$strokeStyle(ctx, "rgba(50, 50, 50, 0.3)");
        for (t3 = _this.__CelestialBody_inclination_A, angle = 0; angle < 6.283185307179586; angle += 0.1) {
          t4 = _this.__CelestialBody_orbitalRadius_A;
          t4 === $ && A.throwLateFieldNI("orbitalRadius");
          t5 = Math.cos(angle);
          t6 = _this.__CelestialBody_orbitalRadius_A;
          t7 = Math.sin(angle);
          t8 = _this.__CelestialBody_orbitalRadius_A;
          t9 = Math.sin(angle);
          t3 === $ && A.throwLateFieldNI("inclination");
          t5 = t4 * t5 * 5681818181818182e-25;
          t9 = t8 * t9 * Math.sin(t3) * 5681818181818182e-25;
          isoOrbit = [(t5 - t9) * Math.cos(0.5235987755982988), t6 * t7 * 5681818181818182e-25 + (t5 + t9) * Math.sin(0.5235987755982988)];
          if (angle === 0)
            ctx.moveTo(isoOrbit[0] + 400, isoOrbit[1] + 300);
          else
            ctx.lineTo(isoOrbit[0] + 400, isoOrbit[1] + 300);
        }
        ctx.stroke();
        t3 = _this.trail;
        if (t3.length > 2) {
          ctx.beginPath();
          B.CanvasRenderingContext2D_methods.set$strokeStyle(ctx, _this.color);
          ctx.lineWidth = 1.5;
          for (i = 0; i < t3.length; ++i) {
            t4 = t3[i];
            t5 = t4[0] * 5681818181818182e-25;
            t6 = t4[1];
            t4 = t4[2] * 5681818181818182e-25;
            isoTrail = [(t5 - t4) * Math.cos(0.5235987755982988), t6 * 5681818181818182e-25 + (t5 + t4) * Math.sin(0.5235987755982988)];
            if (i === 0)
              ctx.moveTo(isoTrail[0] + 400, isoTrail[1] + 300);
            else
              ctx.lineTo(isoTrail[0] + 400, isoTrail[1] + 300);
          }
          ctx.globalAlpha = 0.3;
          ctx.stroke();
          ctx.globalAlpha = 1;
      ...
      ctx.beginPath();
      B.CanvasRenderingContext2D_methods.set$fillStyle(ctx, "rgba(0, 0, 0, 0.3)");
      t3 = _this.radius;
      B.CanvasRenderingContext2D_methods.ellipse$8(ctx, screenX, screenY + t3 * 0.7, t3 * 0.8, t3 * 0.3, 0, 0, 6.283185307179586, false);
      ctx.fill();
      ctx.beginPath();
      t4 = t3 * 0.4;
      t5 = screenX - t4;
      t4 = screenY - t4;
      t6 = ctx.createRadialGradient(t5, t4, 0, screenX, screenY, t3);
      t6.toString;
      if (t1) {
        t6.addColorStop(0, "#FFF7EB");
        t6.addColorStop(0.5, "#FFE87C");
        t6.addColorStop(1, "#FFA500");
      } else {
        t6.addColorStop(0, "rgba(255, 255, 255, 0.8)");
        t1 = _this.color;
        t6.addColorStop(0.3, t1);
        r = A.int_parse(B.JSString_methods.substring$2(t1, 1, 3), 16);
        g = A.int_parse(B.JSString_methods.substring$2(t1, 3, 5), 16);
        b = A.int_parse(B.JSString_methods.substring$2(t1, 5, 7), 16);
        r = B.JSNumber_methods.round$0(r * 0.7);
        g = B.JSNumber_methods.round$0(g * 0.7);
        b = B.JSNumber_methods.round$0(b * 0.7);
        t6.addColorStop(1, "#" + B.JSString_methods.padLeft$2(B.JSInt_methods.toRadixString$1(r, 16), 2, "0") + B.JSString_methods.padLeft$2(B.JSInt_methods.toRadixString$1(g, 16), 2, "0") + B.JSString_methods.padLeft$2(B.JSInt_methods.toRadixString$1(b, 16), 2, "0"));
      }
      B.CanvasRenderingContext2D_methods.set$fillStyle(ctx, t6);
      ctx.arc(screenX, screenY, t3, 0, 6.283185307179586, false);
      ctx.fill();
      ctx.beginPath();
      highlightGradient = ctx.createRadialGradient(t5, t4, 0, t5, t4, t3 * 0.6);
      highlightGradient.addColorStop(0, "rgba(255, 255, 255, 0.4)");
      highlightGradient.addColorStop(1, "rgba(255, 255, 255, 0)");
      B.CanvasRenderingContext2D_methods.set$fillStyle(ctx, highlightGradient);
      ctx.arc(screenX, screenY, t3, 0, 6.283185307179586, false);
      ctx.fill();
      if (t2) {
        B.CanvasRenderingContext2D_methods.set$fillStyle(ctx, _this.color);
        ctx.font = "12px Arial";
        ctx.fillText(_this.name, screenX - 15, screenY - t3 - 5);
      }
      if (_this.isHovered) {
        ctx.beginPath();
        B.CanvasRenderingContext2D_methods.set$strokeStyle(ctx, "rgba(255, 255, 255, 0.5)");
        ctx.lineWidth = 2;
        ctx.arc(screenX, screenY, t3 + 5, 0, 6.283185307179586, false);
        ctx.stroke();
      }
    }
  };
  A.main_closure.prototype = {
    call$1($event) {
      ...
      t1.isPaused = isPaused;
      t1 = isPaused ? "\u041f\u0440\u043e\u0434\u043e\u043b\u0436\u0438\u0442\u044c \u25b6\ufe0f" : "\u041f\u0430\u0443\u0437\u0430 \u23f8\ufe0f";
      B.ButtonElement_methods.set$text(this.pauseButton, t1);
    },
    $signature: 5
  };
  A.main_closure0.prototype = {
    call$1($event) {
      var simulationSpeed,
        t1 = this.speedSlider.value;
      t1.toString;
      simulationSpeed = A.double_parse(t1);
      this._box_0.simulationSpeed = simulationSpeed;
      B.SpanElement_methods.set$text(this.speedValue, B.JSNumber_methods.toStringAsFixed$1(simulationSpeed, 1) + "x");
    },
    $signature: 4
  };
  A.main_closure1.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5, x, y, foundHover, _i, planet, iso, dx, dy;
      type$.MouseEvent._as($event);
      t1 = this.canvas;
      ...
      t2.toString;
      y = t4 - t2;
      for (t2 = this.planets, foundHover = false, _i = 0; _i < 9; ++_i) {
        planet = t2[_i];
        t3 = planet.x * 5681818181818182e-25;
        t4 = planet.y;
        t5 = planet.z * 5681818181818182e-25;
        iso = [(t3 - t5) * Math.cos(0.5235987755982988), t4 * 5681818181818182e-25 + (t3 + t5) * Math.sin(0.5235987755982988)];
        dx = x - (iso[0] + 400);
        dy = y - (iso[1] + 300);
        t5 = planet.radius;
        if (dx * dx + dy * dy <= t5 * t5) {
  ...
  A.main_update.prototype = {
    call$1(time) {
      var t1, t2, t3, t4, _i, planet, t5, t6, t7, flags, i, currentAngle, t8, newAngle, t9, _this = this;
      A._asNum(time);
      t1 = _this.ctx;
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#000000");
      t1.fillRect(0, 0, 800, 600);
      t2 = _this._box_0;
      if (!t2.isPaused)
        for (t3 = _this.planets, t4 = type$.JSArray_double, _i = 0; _i < 9; ++_i) {
          planet = t3[_i];
          for (t5 = !planet.isSun, t6 = planet.trail, t7 = planet.__CelestialBody_inclination_A, flags = t6.$flags | 0, i = 0; i < t2.simulationSpeed; ++i)
            if (t5) {
              currentAngle = Math.atan2(planet.y, planet.x);
              t8 = planet.__CelestialBody_angularVelocity_A;
              t8 === $ && A.throwLateFieldNI("angularVelocity");
              newAngle = currentAngle + t8 * 86400;
              t8 = planet.__CelestialBody_orbitalRadius_A;
              t8 === $ && A.throwLateFieldNI("orbitalRadius");
              planet.x = t8 * Math.cos(newAngle);
              t8 = planet.__CelestialBody_orbitalRadius_A;
              t9 = Math.sin(newAngle);
              t7 === $ && A.throwLateFieldNI("inclination");
              planet.y = t8 * t9 * Math.cos(t7);
              t9 = planet.__CelestialBody_orbitalRadius_A * Math.sin(newAngle) * Math.sin(t7);
              planet.z = t9;
              B.JSArray_methods.add$1(t6, A._setArrayType([planet.x, planet.y, t9], t4));
              if (t6.length > 50) {
                flags & 1 && A.throwUnsupportedOperation(t6, "removeAt", 1);
                t6.splice(0, 1)[0];
              }
            }
        }
      for (t2 = _this.planets, _i = 0; _i < 9; ++_i)
        t2[_i].draw$1(t1);
      t1 = window;
      t1.toString;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A.CelestialBody]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.CanvasRenderingContext2D, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.DomRectReadOnly, A.Event]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_update]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.CanvasElement, A.FormElement, A.InputElement, A.SelectElement, A.SpanElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_CelestialBody: findType("JSArray<CelestialBody>"),
